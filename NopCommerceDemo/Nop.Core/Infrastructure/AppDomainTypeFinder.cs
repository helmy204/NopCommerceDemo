...
namespace Nop.Core.Infrastructure
{
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        private string assemblyRestrictedToLoadingPattern = ".*";
        ...
        ///  For ease of use this defaults to match all but to increase
        ///  performance you might want to configure a pattern that includes
        ///  assemblies and your own.
        /// </summary>
        ...
        {
            get { return assemblyRestrictedToLoadingPattern; }
            set { assemblyRestrictedToLoadingPattern = value; }
        }
        ...
        /// <summary>
        /// Iteraates all assemblies in the AppDomain and if it's name matches
        /// the configured patterns add it to our list.
        /// </summary>
