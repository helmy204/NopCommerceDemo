...
namespace Nop.Core.Configuration
{
    ...
    public partial class NopConfig : IConfigurationSectionHandler
    {
        ...
        public object Create(object parent, object configContext, XmlNode section)
        {
            ...
            var dynamicDiscoverNode = section.SelectSingleNode("DynamicDiscovery");
            if(dynamicDiscoverNode!=null&&dynamicDiscoverNode.Attributes!=null)
            {
                var attribute = dynamicDiscoverNode.Attributes["Enabled"];
                if (attribute != null)
        ...
        /// <summary>
        /// Specifies where the theme will be stored (~/Themes/)
        /// </summary>
